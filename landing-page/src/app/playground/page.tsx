      ...
      >
        ...
        <div className="fixed inset-0 pointer-events-none" aria-hidden="true">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse, rgba(168,255,62,0.06) 0%, transparent 65%)",
            }}
          />
          {/* Indigo bottom-left */}
          <div
        ...
        >
          <svg
            className="absolute w-[700px] h-[700px] opacity-[0.04]"
            viewBox="0 0 700 700"
          >
            <circle
              cx="350"
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 font-mono text-[10px] font-bold uppercase tracking-widest mb-8 px-3 py-2 rounded-full"
            style={{
          ...
          {/* Headline */}
          <h1
            className="font-display font-bold text-white leading-[1.02] tracking-tight mb-5"
          ...
          <p
            ...
            style={{ color: "#6B6B85" }}
          >
            Simulate agentic transactions on Stellar testnet, test x402
            pay-per-action flows, and validate Soroban guardrails — before your
            agents touch real funds.
          </p>
          ...
          {!done ? (
            <div className="flex items-end gap-6 md:gap-10 mb-14">
              ...
              <span
                className="font-display font-bold mb-8 md:mb-10"
                style={{
            ...
            <div
              className="mb-14 font-display font-bold text-4xl"
              style={{ color: "#A8FF3E" }}
            >
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="w-full max-w-md">
              ...
              {error && (
                <p
                  className="mt-2 text-xs font-mono text-left"
                  style={{ color: "#FB923C" }}
                >
                  {error}
                </p>
              ...
              <p
                className="mt-3 text-[11px] font-mono text-left"
            ...
            >
              ...
              <p className="text-xs" style={{ color: "#6B6B85" }}>
                We&apos;ll email{" "}
                <span style={{ color: "#A8FF3E" }}>{email}</span> when the
                playground opens.
              </p>
            </div>
          )}
          ...
          <div className="mt-20 w-full max-w-3xl">
            <p
              className="font-mono text-[10px] font-bold uppercase tracking-widest mb-8"
              style={{ color: "rgba(255,255,255,0.15)" }}
            >
              ...
              {[
                {
                  ...
                  icon: (
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path
                        d="M3.5 10h13M10 3.5l6.5 6.5-6.5 6.5"
                        stroke="#A8FF3E"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
          ...
          <div
            className="mt-10 flex items-center gap-2 font-mono text-xs"
          ...
          >
            ...
            Runs on Stellar testnet · No real funds required · Free for early
            access users
          </div>
        </div>
      </main>

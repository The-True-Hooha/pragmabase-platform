...
export const metadata: Metadata = {
  ...
  description:
    "Open research on agentic economics, memory architectures, and autonomous system reliability.",
};
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p
                  ...
                  style={{ color: "#6B6B85" }}
                >
                  We publish our architecture papers, protocol specs, and
                  benchmark findings openly. Good infrastructure is built on
              ...
              {papers.map((paper, i) => (
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <a
                      href="#"
                      className="shrink-0 text-sm font-medium px-5 py-2.5 rounded-xl transition-all"
                      style={{
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {openSource.map((repo) => (
                <a
                  key={repo.name}
                  href="#"
                  className="block rounded-2xl p-6 group transition-all duration-300 hover:-translate-y-0.5"
                  style={{
                    background: "#14141F",
                    border: `1px solid ${repo.color}18`,
                  }}
                >
                  ...
                  <span
                    ...
                    style={{ color: langColor[repo.lang] }}
                  >
                    <span
...
function ResearchIllustration() {
  ...
  return (
    ...
    >
      ...
      >
        Agent performance · dual-state model
      </text>
      {bars.map((v, i) => {
        const h = (v / 100) * maxH;
        const x = 36 + i * 21;

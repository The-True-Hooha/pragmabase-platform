...
const features = [
  {
    ...
    accentBorder: "rgba(196,181,253,0.15)",
    number: "01",
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        />
        <path
          d="M4 7v4c0 1.933 3.134 3.5 7 3.5s7-1.567 7-3.5V7"
          stroke="#C4B5FD"
          strokeWidth="1.4"
        />
        <path
          d="M4 11v4c0 1.933 3.134 3.5 7 3.5s7-1.567 7-3.5v-4"
          stroke="#C4B5FD"
          strokeWidth="1.4"
        />
      </svg>
  ...
  },
  {
    ...
    accentBorder: "rgba(168,255,62,0.15)",
    number: "02",
    title: "Stellar-Native Payments",
    ...
    tags: ["USDC", "XLM", "Soroban"],
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <circle cx="11" cy="11" r="8.5" stroke="#A8FF3E" strokeWidth="1.4" />
        <path
          d="M11 5.5v11M8 8l7 3-7 3"
          stroke="#A8FF3E"
          strokeWidth="1.4"
          strokeLinecap="round"
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <rect
          ...
          strokeWidth="1.4"
        />
        <path d="M3 10h16" stroke="#818CF8" strokeWidth="1.4" />
        <path
          d="M6.5 14h3.5M16 14h1.5"
          stroke="#818CF8"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    number: "04",
    title: "Team-Based Agent Systems",
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <circle cx="8" cy="8" r="3.5" stroke="#34D399" strokeWidth="1.4" />
        <circle cx="16" cy="8" r="3.5" stroke="#34D399" strokeWidth="1.4" />
        <circle cx="12" cy="16" r="3.5" stroke="#34D399" strokeWidth="1.4" />
        <path
          d="M11.5 8h-3M13 13l2-5M10 13l-2 2"
          stroke="#34D399"
          strokeWidth="1"
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M3 7.5h16" stroke="#67E8F9" strokeWidth="1.4" />
      </svg>
    ),
  },
];
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 py-20 md:py-28">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          ...
          <p className="text-base max-w-sm" style={{ color: "#6B6B85" }}>
            Six infrastructure primitives that transform agents from stateless
            tools into stateful economic entities.
          </p>
        </div>

...
export function CTA() {
  return (
    <section className="overflow-hidden relative" style={{ background: 'linear-gradient(145deg, #0D0520 0%, #1A0A3E 30%, #2D1463 65%, #1A0A3E 100%)' }}>
      {/* Purple glow */}
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 50% 60%, rgba(124,58,237,0.35) 0%, transparent 65%)' }} />
      {/* Lime glow top */}
      <div className="absolute top-0 right-[20%] w-[500px] h-[300px] pointer-events-none"
      ...
      {/* Decorative SVG */}
      <svg className="absolute right-0 top-0 h-full opacity-[0.07] pointer-events-none" viewBox="0 0 500 400" fill="none" preserveAspectRatio="xMidYMid slice">
        <circle cx="400" cy="200" r="180" stroke="white" strokeWidth="0.75" strokeDasharray="8 8"/>
        ...
        <line x1="100" y1="200" x2="380" y2="200" stroke="white" strokeWidth="0.5" strokeDasharray="4 4"/>
        <line x1="400" y1="20" x2="400" y2="180" stroke="white" strokeWidth="0.5" strokeDasharray="4 4"/>
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 md:px-8 py-24 md:py-32">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <motion.p initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.16 }}
            className="text-lg leading-relaxed mb-10 max-w-xl mx-auto" style={{ color: 'rgba(196,181,253,0.65)' }}>
            The future of AI is economically active, memory-driven, and reliability-tested.
            Pragmabase is building that future — join us.
          </motion.p>

          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.24 }}
            ...
            <a href="/playground"
              ...
              style={{ background: '#A8FF3E', color: '#0A0A0F', boxShadow: '0 12px 40px rgba(168,255,62,0.3)' }}
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }}
            ...
            {[
              ...
              <div key={item.text} className="flex items-center gap-2 text-sm font-medium" style={{ color: 'rgba(196,181,253,0.5)' }}>
